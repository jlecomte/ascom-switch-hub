...
#define MyAppName "ASCOM Switch Hub"
#define MyAppVersion "1.1.1"
#define MyAppURL "https://github.com/jlecomte/ascom-switch-hub"

[Setup]
AppId={{495874AE-20EE-48F3-ABC9-781C5E02A867}
...
SourceDir="C:\Users\Julien\source\repos\ascom-switch-hub"
OutputDir="Installer"
...
[Files]
Source: "ASCOM_Driver\bin\Release\ASCOM.DarkSkyGeek.SwitchHub.dll"; DestDir: "{app}"

[Run]
Filename: "{dotnet4032}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.DarkSkyGeek.SwitchHub.dll"""; Flags: runhidden 32bit
Filename: "{dotnet4064}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.DarkSkyGeek.SwitchHub.dll"""; Flags: runhidden 64bit; Check: IsWin64

[UninstallRun]
Filename: "{dotnet4032}\regasm.exe"; Parameters: "-u ""{app}\ASCOM.DarkSkyGeek.SwitchHub.dll"""; Flags: runhidden 32bit
; This helps to give a clean uninstall
Filename: "{dotnet4064}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.DarkSkyGeek.SwitchHub.dll"""; Flags: runhidden 64bit; Check: IsWin64
Filename: "{dotnet4064}\regasm.exe"; Parameters: "-u ""{app}\ASCOM.DarkSkyGeek.SwitchHub.dll"""; Flags: runhidden 64bit; Check: IsWin64
